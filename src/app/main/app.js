...
.directive('header', ['$popover', function($popover) {
    return {
        restrict: 'E',
        templateUrl: '/app/main/vaccination_unadministered.html',
                ...
                post: function postLink(scope, element, attributes) {
                    ...
                    scope.getContentUrl = function(){
                        if (scope.vaccination.hasOwnProperty('_staged')) {
                            return '/app/main/vaccination_staged_template.html';
                        }
                        else if (scope.vaccination.administered){
                            return '/app/main/vaccination_administered.html';
                        }
                        else if (!scope.vaccination.administered){
                            return '/app/main/vaccination_unadministered.html';
                        }
                    };
                    if (scope.vaccination.hasOwnProperty('_staged')) {
